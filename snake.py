...
class SnakeBody(Objects.SolidObject):
    color = Engine.MyColors.BRIGHT_GREEN
...
def populate_room(room):
    ...
    for _ in range(6):
        room.create(Food)
room = Rooms.GameRoom(populate_room, bgcolor=Engine.MyColors.NAVY_BLUE)
